...
function Select(_ref) {
  ...
  var otherProps = _objectWithoutProperties(_ref, ['options', 'id', 'label', 'expanded', 'kind', 'size', 'state', 'message']);
  ...
  if ((typeof options === 'undefined' ? 'undefined' : _typeof(options)) == 'object') {
    parsedOptions = Object.keys(options).map(function (option) {
      return { value: option, title: options[option] };
    });
  } else {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        parsedOptions.map(function (_ref2, idx) {
